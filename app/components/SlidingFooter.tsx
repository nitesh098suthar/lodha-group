...
export default function SlidingFooter() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 z-30 bg-white shadow-2xl transition-transform duration-300 ease-in-out md:hidden ${
        ...
        <div className="overflow-y-auto h-full pb-20">
          <div className="p-6">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <p className="text-gray-600 text-sm mb-2">Lodha Group</p>
      ...
      <footer className="hidden md:block bg-gradient-to-r from-[#8B6914] to-[#B8860B] text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Lodha Group</h3>
              <p className="text-gray-400 text-sm">
                Premium real estate developer offering luxury homes and commercial spaces.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="mailto:info@lodhagroup.com" className="hover:text-white transition-colors">info@lodhagroup.com</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
            <p>© {new Date().getFullYear()} Lodha Group. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
