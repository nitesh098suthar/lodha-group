...
export default function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#1A1A1A] border-t border-white/10 shadow-lg pb-safe">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] md:text-xs font-medium mt-1">{item.label}</span>
                {isActive && (
