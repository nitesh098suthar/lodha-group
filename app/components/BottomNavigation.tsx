      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <Link
          ...
          className={`flex flex-col items-center justify-center py-2 px-4 min-w-[60px] transition-colors ${
            pathname === '/' ? 'text-[#D4AF37]' : 'text-gray-500'
          }`}
        >
        ...
        <Link
          href="#properties"
          className="flex flex-col items-center justify-center py-2 px-4 min-w-[60px] text-gray-500 transition-colors"
        >
          <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          href="/profile"
          className={`flex flex-col items-center justify-center py-2 px-4 min-w-[60px] transition-colors ${
            pathname === '/profile' ? 'text-[#D4AF37]' : 'text-gray-500'
          }`}
        >
          <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
